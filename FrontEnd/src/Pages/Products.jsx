...
const Products = () => {
  ...
  return (
    <>
      {q ? (
        <>
          <div className="m-3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 justify-center pb-10 mt-35 bg-gray-100 py-5 rounded-2xl">
            {products.length === 0 ? (
      ...
      <InfiniteScroll
        className="mt-35 bg-gray-100 py-5 rounded-2xl"
